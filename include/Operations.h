...
/*
Function: Calculate the screw axis of a revolute joint
Inputs:
joint_type: The type of joint, either "revolute" or "prismatic"
axis_direction: The direction of the joint axis
point_on_axis: A point that lies on the joint axis

Returns: The screw axis of the joint in a 6x1 vector
*/
